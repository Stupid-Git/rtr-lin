/**
 * @file    rf_thread_entry.h
 *
 * @date    Created on: 2019/03/06
 * @author  haya
 * @note    2020.Jun.18 ヘッダファイル整理（グローバル定義されていた関数をstaticに移動）
 * @note    2020.Jul.07 auto_thread配下の関数をauto_thread_entryに移した
 */
...
#ifndef _RF_THREAD_ENTRY_H_
#define _RF_THREAD_ENTRY_H_
...
//Globals.hから移動
EDF char complement_info[4];

EDF char     rf_command;
EDF char     my_rpt_number;


#endif /* _RF_THREAD_ENTRY_H_ */
