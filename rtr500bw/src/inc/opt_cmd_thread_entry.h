/**
 * @brief   光通信スレッド ヘッダファイル
 * @file    opt_cmd_thread_entry.h
 *
 * @date    2019/02/28
 * @author  haya
 * @note    2020.Jul.03 ソースファイルの整理、関数の整理
 */
...
#ifndef _OPT_CMD_THREAD_ENTRY_H_
#define _OPT_CMD_THREAD_ENTRY_H_
...
#ifndef _OPT_CMD_THREAD_ENTRY_C_
    #define EDF extern
#else
    #define EDF
#endif
...
#endif /* _OPT_CMD_THREAD_ENTRY_H_ */
