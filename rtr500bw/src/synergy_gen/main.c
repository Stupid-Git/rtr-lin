...
extern void cmd_thread_create(void);
extern void ble_thread_create(void);
extern void usb_thread_create(void);
extern void http_thread_create(void);
extern void network_thread_create(void);
extern void rf_thread_create(void);
extern void opt_cmd_thread_create(void);
extern void test_thread_create(void);
extern void udp_thread_create(void);
extern void tcp_thread_create(void);
extern void wifi_thread_create(void);
extern void ftp_thread_create(void);
extern void smtp_thread_create(void);
extern void event_thread_create(void);
extern void led_thread_create(void);
extern void power_down_thread_create(void);
extern void auto_thread_create(void);
extern void sntp_thread_create(void);
extern void usb_tx_thread_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    event_thread_create ();
    led_thread_create ();
    power_down_thread_create ();
    auto_thread_create ();
    sntp_thread_create ();
    usb_tx_thread_create ();
